---
title: "Chats herunterladen Anleitung"
type: chatgpt_conversation
source: chatgpt
source_id: "6a33e238-1fc4-83eb-9add-4b99f0db175b"
created: 2026-06-18
tags:
  - chatgpt
  - import
...
# Chats herunterladen Anleitung

## Metadaten

- Quelle: ChatGPT Export
- Conversation ID: `6a33e238-1fc4-83eb-9add-4b99f0db175b`
- Nachrichten: 4
...
└── KI_Chatverläufe
    ├── ChatGPT
    │   ├── 2026-06-18_Projektplanung.md
    │   ├── 2026-06-18_Jarvis_Masterplan.md
    │   └── ...
    ├── Claude
    ├── Gemini
    └── Perplexity
...
wie lade ich die chats herunter
...
4. Export als:
   - Dokument in urlGoogle Docshttps://docs.google.com
   - E-Mail in urlGmailhttps://mail.google.com
   - Kopieren und als Markdown speichern

### Alle Gemini-Chats exportieren
Gemini-Chats sind Teil deiner Google-Daten und können über urlGoogle Takeouthttps://takeout.google.com exportiert werden.
...
└── KI_Chatverläufe
    ...
    ├── Gemini
    └── Perplexity
        ├── 2026-06-18_LLM_Vergleich.md
        ├── 2026-06-18_Recherche_XYZ.md
        └── ...
```
